...
public class CharacterDetailView : MonoBehaviour
{
    ...
    private void Reset()
    {
        ...
        foreach(Button button in buttons)
        {
            ...
            if(_optionButton == null && objName.Contains("option")) _optionButton = button;
    ...
    public void OnClickOptionButton(Action action)
    {
        _optionButton.onClick.RemoveAllListeners();
        _optionButton.onClick.AddListener(() => action.Invoke());
    }
